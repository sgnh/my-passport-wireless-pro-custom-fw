...
ifeq ($(BR2_PACKAGE_AVAHI_AUTOIPD),y)
	...
	#ln -sf /usr/sbin/avahi-autoipd $(TARGET_DIR)/var/lib/avahi-autoipd
endef
...
define AVAHI_INSTALL_INIT_SYSTEMD
	...
	$(INSTALL) -D -m 777 package/avahi/avahi-autoipd.action \
		$(TARGET_DIR)/etc/avahi/avahi-autoipd.action
endef
