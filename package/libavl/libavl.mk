...
LIBAVL_INSTALL_TARGET = YES

define LIBAVL_EXTRACT_CMDS
	tar zxvf $(DL_DIR)/$(LIBAVL_SOURCE) -C $(@D)
endef
...
$(TARGET_DIR)/$(LIBAVL_TARGET_LIBRARY): $(LIBAVL_DIR)/$(LIBAVL_TARGET)
		...
		ln -s $(STAGING_DIR)/$(LIBAVL_TARGET_LIBRARY) $(STAGING_DIR)/$(LIBAVL_DESTDIR)/libavl.so
