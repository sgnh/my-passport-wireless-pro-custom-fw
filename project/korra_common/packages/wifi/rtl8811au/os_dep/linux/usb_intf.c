...
static struct usb_device_id rtw_usb_id_tbl[] ={
	...
	{USB_DEVICE_AND_INTERFACE_INFO(USB_VENDER_ID_REALTEK, 0x0821,0xff,0xff,0xff),.driver_info = RTL8821}, /* 8821AU */
	/*=== Customer ID ===*/
	{USB_DEVICE(0x20F4, 0x804B),.driver_info = RTL8821},/* 20140211: ADD FOR RIRI */
