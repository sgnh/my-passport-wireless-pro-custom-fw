...
#if  (!defined(CONFIG_CONSUMER_WD)) || defined(CONFIG_WIFI_TEST)
...
typedef enum _RT_CHANNEL_DOMAIN
{
	...
	RT_CHANNEL_DOMAIN_5G_ONLY = 0x59,
...
#define RTW_STAY_AP_CH_MILLISECOND		4	// this value is a multiplier,for example, when this value is 3, 
							// it would stay AP's op ch for  3 * SURVEY_TO millisecond.
#else
#define RTW_STAY_AP_CH_MILLISECOND		20
#endif
#endif 
...
void issue_addba_req_wait_ack(_adapter *adapter, unsigned char *ra, u8 tid);
