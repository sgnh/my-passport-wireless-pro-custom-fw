...
//#ifndef CONFIG_MP_INCLUDED
	...
	#define CONFIG_CONCURRENT_MODE 1
		...
		/* Multi Channel Concurrent */
			...
			#define CONFIG_AP_TX_UNDER_SCAN
			//#define CONFIG_MCC_MODE_DEBUG 1
			//#ifdef CONFIG_MCC_MODE_DEBUG
				//#define DBG_EXPIRATION_CHK 1
				//#define DBG_XMIT_ACK 1
				//#define DBG_CH_SWITCH 1
			//#endif
			#ifdef CONFIG_LPS
				#undef CONFIG_LPS
			#endif /*CONFIG_LPS*/
...
#define CONFIG_FW_C2H_DEBUG 1
#define CONFIG_CONSUMER_WD 1
