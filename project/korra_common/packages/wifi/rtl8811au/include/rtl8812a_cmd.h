...
typedef enum _RTL8812_H2C_CMD 
{
	...
	H2C_8812_MCC_LOCATION = 0x10,
	H2C_8812_MCC_INFO = 0x11,
	H2C_8812_MCC_UPDATE_PARAM = 0x15,
	H2C_8812_MCC_MACID_BITMAP = 0x16,
	H2C_8812_MCC_LOCATION_V2 = 0x17,
	H2C_8812_MCC_INFO_V2 = 0x18,
#endif
...
#define GET_8812_C2H_TX_RPT_SW_DEFINE(_Header)      LE_BITS_TO_1BYTE((_Header + 6), 0, 8)
