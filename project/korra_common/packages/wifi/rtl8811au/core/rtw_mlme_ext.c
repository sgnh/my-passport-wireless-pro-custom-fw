...
static RT_CHANNEL_PLAN_MAP	RTW_ChannelPlanMap[RT_CHANNEL_DOMAIN_MAX] = {
	...
	{0x06,0x20},	//0x00, RT_CHANNEL_DOMAIN_FCC
	{0x06,0x0A},	//0x01, RT_CHANNEL_DOMAIN_IC
	{0x06,0x01},	//0x02, RT_CHANNEL_DOMAIN_ETSI
	{0x06,0x00},	//0x03, RT_CHANNEL_DOMAIN_SPAIN
	{0x06,0x00},	//0x04, RT_CHANNEL_DOMAIN_FRANCE
	{0x06,0x00},	//0x05, RT_CHANNEL_DOMAIN_MKK
	{0x06,0x00},	//0x06, RT_CHANNEL_DOMAIN_MKK1
	{0x06,0x09},	//0x07, RT_CHANNEL_DOMAIN_ISRAEL
	{0x06,0x09},	//0x08, RT_CHANNEL_DOMAIN_TELEC
	{0x06,0x00},	//0x09, RT_CHANNEL_DOMAIN_GLOBAL_DOAMIN
	{0x06,0x00},	//0x0A, RT_CHANNEL_DOMAIN_WORLD_WIDE_13
	{0x06,0x0F},	//0x0B, RT_CHANNEL_DOMAIN_TAIWAN
	{0x06,0x08},	//0x0C, RT_CHANNEL_DOMAIN_CHINA
	{0x06,0x06},	//0x0D, RT_CHANNEL_DOMAIN_SINGAPORE_INDIA_MEXICO
	{0x06,0x0B},	//0x0E, RT_CHANNEL_DOMAIN_KOREA
	{0x06,0x09},	//0x0F, RT_CHANNEL_DOMAIN_TURKEY
	{0x06,0x01},	//0x10, RT_CHANNEL_DOMAIN_JAPAN
	{0x06,0x05},	//0x11, RT_CHANNEL_DOMAIN_FCC_NO_DFS
	{0x06,0x21},	//0x12, RT_CHANNEL_DOMAIN_JAPAN_NO_DFS
	{0x06,0x04},	//0x13, RT_CHANNEL_DOMAIN_WORLD_WIDE_5G
	{0x06,0x10},	//0x14, RT_CHANNEL_DOMAIN_TAIWAN_NO_DFS
	{0x06,0x21},	//0x15, RT_CHANNEL_DOMAIN_ETSI_NO_DFS
	{0x06,0x22},	//0x16, RT_CHANNEL_DOMAIN_KOREA_NO_DFS
	{0x06,0x21},	//0x17, RT_CHANNEL_DOMAIN_JAPAN_NO_DFS
	{0x06,0x08},	//0x18, RT_CHANNEL_DOMAIN_PAKISTAN_NO_DFS
	{0x06,0x08},	//0x19, RT_CHANNEL_DOMAIN_TAIWAN2_NO_DFS
	{0x06,0x00},	//0x1A,
	{0x06,0x00},	//0x1B,
	{0x06,0x00},	//0x1C,
	{0x06,0x00},	//0x1D,
	...
	{0x06,0x00},	//0x20, RT_CHANNEL_DOMAIN_WORLD_NULL
	{0x06,0x00},	//0x21, RT_CHANNEL_DOMAIN_ETSI1_NULL
	{0x06,0x00},	//0x22, RT_CHANNEL_DOMAIN_FCC1_NULL
	{0x06,0x00},	//0x23, RT_CHANNEL_DOMAIN_MKK1_NULL
	{0x06,0x00},	//0x24, RT_CHANNEL_DOMAIN_ETSI2_NULL
	{0x06,0x04},	//0x25, RT_CHANNEL_DOMAIN_FCC1_FCC1
	{0x06,0x12},	//0x26, RT_CHANNEL_DOMAIN_WORLD_ETSI1
	{0x06,0x0C},	//0x27, RT_CHANNEL_DOMAIN_MKK1_MKK1
	{0x06,0x20},	//0x28, RT_CHANNEL_DOMAIN_5G_KCC2
	{0x06,0x05},	//0x29, RT_CHANNEL_DOMAIN_WORLD_FCC2
	{0x06,0x00},	//0x2A,
	{0x06,0x00},	//0x2B,
	{0x06,0x00},	//0x2C,
	{0x06,0x00},	//0x2D,
	{0x06,0x00},	//0x2E,
	{0x06,0x00},	//0x2F,
	{0x06,0x05},	//0x30, RT_CHANNEL_DOMAIN_WORLD_FCC3
	{0x06,0x07},	//0x31, RT_CHANNEL_DOMAIN_WORLD_FCC4
	{0x06,0x08},	//0x32, RT_CHANNEL_DOMAIN_WORLD_FCC5
	{0x06,0x09},	//0x33, RT_CHANNEL_DOMAIN_WORLD_FCC6
	{0x06,0x21},	//0x34, RT_CHANNEL_DOMAIN_5G_FCC11
	{0x06,0x02},	//0x35, RT_CHANNEL_DOMAIN_WORLD_ETSI2
	{0x06,0x03},	//0x36, RT_CHANNEL_DOMAIN_WORLD_ETSI3
	{0x06,0x0D},	//0x37, RT_CHANNEL_DOMAIN_MKK1_MKK2
	{0x06,0x0E},	//0x38, RT_CHANNEL_DOMAIN_MKK1_MKK3
	{0x06,0x22},	//0x39, RT_CHANNEL_DOMAIN_5G_NCC5
	{0x06,0x00},	//0x3A,
	{0x06,0x00},	//0x3B,
	{0x06,0x00},	//0x3C,
	{0x06,0x00},	//0x3D,
	{0x06,0x00},	//0x3E,
	{0x06,0x00},	//0x3F,
	{0x06,0x10},	//0x40, RT_CHANNEL_DOMAIN_FCC1_NCC2
	{0x06,0x00},	//0x41, RT_CHANNEL_DOMAIN_GLOBAL_NULL
	{0x06,0x12},	//0x42, RT_CHANNEL_DOMAIN_ETSI1_ETSI4
	{0x06,0x05},	//0x43, RT_CHANNEL_DOMAIN_FCC1_FCC2
	{0x06,0x11},	//0x44, RT_CHANNEL_DOMAIN_FCC1_NCC3
	{0x06,0x05},	//0x45, RT_CHANNEL_DOMAIN_WORLD_ETSI5
	{0x06,0x14},	//0x46, RT_CHANNEL_DOMAIN_FCC1_FCC8
	{0x06,0x15},	//0x47, RT_CHANNEL_DOMAIN_WORLD_ETSI6
	{0x06,0x05},	//0x48, RT_CHANNEL_DOMAIN_WORLD_ETSI7
	{0x06,0x17},	//0x49, RT_CHANNEL_DOMAIN_WORLD_ETSI8
	{0x06,0x00},	//0x4A,
	{0x06,0x00},	//0x4B,
	{0x06,0x00},	//0x4C,
	{0x06,0x00},	//0x4D,
	{0x06,0x00},	//0x4E,
	{0x06,0x00},	//0x4F,
	{0x06,0x18},	//0x50, RT_CHANNEL_DOMAIN_WORLD_ETSI9
	{0x06,0x19},	//0x51, RT_CHANNEL_DOMAIN_WORLD_ETSI10
	{0x06,0x1A},	//0x52, RT_CHANNEL_DOMAIN_WORLD_ETSI11
	{0x06,0x1B},	//0x53, RT_CHANNEL_DOMAIN_FCC1_NCC4
	{0x06,0x1C},	//0x54, RT_CHANNEL_DOMAIN_WORLD_ETSI12
	{0x06,0x1D},	//0x55, RT_CHANNEL_DOMAIN_FCC1_FCC9
	{0x06,0x1E},	//0x56, RT_CHANNEL_DOMAIN_WORLD_ETSI13
	{0x06,0x1F},	//0x57, RT_CHANNEL_DOMAIN_FCC1_FCC10
	{0x06,0x23},	//0x58, RT_CHANNEL_DOMAIN_WORLD_MKK4
	{0x06,0x05},    //0x59, Primax, 5G only, Janet 2015/04/15 NO_DFS
};

static RT_CHANNEL_PLAN_MAP	RTW_CHANNEL_PLAN_MAP_REALTEK_DEFINE = {0x06,0x05}; //use the conbination for max channel numbers
...
unsigned int OnBeacon(_adapter *padapter, union recv_frame *precv_frame)
{
	...
	/*DBG_871X("%s, port:%d\n", __func__, get_iface_type(padapter));*/
	...
	if (padapter->registrypriv.wifi_spec) {
		if (check_fwstate(pmlmepriv, WIFI_AP_STATE) == _TRUE && pmlmeext->bstart_bss == _TRUE) {
			int left;
			u16 capability;
			unsigned char *pos;
...
unsigned int OnAuth(_adapter *padapter, union recv_frame *precv_frame)
{
	...
	if(((pmlmeinfo->state&0x03) == WIFI_FW_AP_STATE) &&
		check_buddy_fwstate(padapter, _FW_UNDER_LINKING|_FW_UNDER_SURVEY))
	{
#ifndef CONFIG_CONSUMER_WD
		//don't process auth request;
		return _SUCCESS;
#else
		if (check_buddy_fwstate(padapter, _FW_UNDER_SURVEY)) {
			rtw_set_scan_deny(padapter->pbuddy_adapter, 5000);
			padapter->dvobj->scan_abort = _TRUE;
		} else 
			return _SUCCESS;
#endif
	}
	...
	{
#ifdef CONFIG_IEEE80211W
		if (!pstat->wpa2_group_mgmt_cipher) 
#endif /* CONFIG_IEEE80211W */
		{
			_enter_critical_bh(&pstapriv->asoc_list_lock, &irqL);
...
#ifdef CONFIG_IEEE80211W
				pstat->bpairwise_key_installed = _FALSE;
#endif /* CONFIG_IEEE80211W */
			}
			_exit_critical_bh(&pstapriv->asoc_list_lock, &irqL);
...
unsigned int OnAssocReq(_adapter *padapter, union recv_frame *precv_frame)
{
	...
	if((psecuritypriv->wpa_psk & BIT(1)) && elems.rsn_ie) {
		...
		int group_cipher=0, pairwise_cipher=0, group_mgmt_cipher=0;	
		
		wpa_ie = elems.rsn_ie;
		wpa_ie_len = elems.rsn_ie_len;

		if(rtw_parse_wpa2_ie(wpa_ie-2, wpa_ie_len+2, &group_cipher, &pairwise_cipher, NULL, &group_mgmt_cipher) == _SUCCESS)
		{
			...
			pstat->wpa2_group_mgmt_cipher = group_mgmt_cipher&psecuritypriv->wpa2_group_mgmt_cipher;
	...
	{		    
		DBG_871X("(V)HT: " MAC_FMT " tried to "
				   "use TKIP with (V)HT association\n", MAC_ARG(pstat->hwaddr));
...
#ifdef CONFIG_IEEE80211W
		if (pstat->bpairwise_key_installed == _TRUE && pstat->wpa2_group_mgmt_cipher) {
...
unsigned int OnAction_sa_query(_adapter *padapter, union recv_frame *precv_frame)
{
	...
	switch (pframe[WLAN_HDR_A3_LEN+1])
	{
		case 0: //SA Query req
			...
			issue_action_SA_Query(padapter, GetAddr2Ptr(pframe), 1, tid, 0);
			break;
		...
		case 1: //SA Query rsp
			...
			((psta = rtw_get_stainfo(pstapriv, GetAddr2Ptr(pframe))) != NULL)) {
	...
	switch (action)
	{
		case 0: //SA Query req
			...
			if(pattrib->key_type == IEEE80211W_RIGHT_KEY) {
				...
				((psta = rtw_get_stainfo(pstapriv, raddr)) != NULL)) {
...
#if 0
inline void issue_addba_req_wait_ack(_adapter *adapter, unsigned char *ra, u8 tid)
{
	int ret = _FAIL;
	int i = 0;
	u32 start = rtw_get_current_time();
	int try_cnt = 3, wait_ms = 50;

	do {
		ret = issue_action_ba(adapter, ra, RTW_WLAN_ACTION_ADDBA_REQ
			, tid
			, 0 /* unused */
			, 0 /* unused */
			, 0 /* unused */
...
void site_survey(_adapter *padapter)
{
	...
	if(survey_channel != 0 
#ifdef CONFIG_CONSUMER_WD
		&& _TRUE != padapter->dvobj->scan_abort
#endif 
	)
	{
...
#endif
#ifdef CONFIG_AP_TX_UNDER_SCAN
			if (stay_buddy_ch == 1)
				set_channel_bwmode(padapter, survey_channel, 
						pbuddy_mlmeext->cur_ch_offset, pbuddy_mlmeext->cur_bwmode);
			else
				set_channel_bwmode(padapter, survey_channel, HAL_PRIME_CHNL_OFFSET_DONT_CARE, CHANNEL_WIDTH_20);
#else			
	...
	else
	{
...
#ifdef CONFIG_CONSUMER_WD
		if (_TRUE == padapter->dvobj->scan_abort)
			padapter->dvobj->scan_abort = _FALSE;
#endif 
...
#endif //CONFIG_P2P
		{
			...
			{
#ifdef CONFIG_MCC_MODE				
				/* Don't issue nulldata 0 to AP under MCC mode to avoid AP tx data to station */
				if (!(_TRUE == padapter->registrypriv.en_mcc && 
				...
				if (_TRUE == padapter->registrypriv.en_mcc) {
					...
					if (rtw_hal_check_mcc_status(padapter, MCC_STATUS_NEED_MCC)) {
						if (!rtw_hal_check_mcc_status(padapter, MCC_STATUS_DOING_MCC)) {
							DBG_871X(FUNC_ADPT_FMT": restart mcc mode after scanning done!\n", FUNC_ADPT_ARG(padapter));

							/* return _TURE for starting MCC sucessfully */
							if (rtw_hal_set_mcc_setting(padapter,  _FALSE) != _TRUE) {
								DBG_871X("restart mcc mode fail\n");
							} else {
								DBG_871X("restart mcc mode success\n");
							}
						} else 
							DBG_871X("%s: under mcc mode\n", __func__);
					}
...
#endif //CONFIG_CONCURRENT_MODE
#ifdef CONFIG_MCC_MODE
	/* means buddy adapter is under linking */
	else if (_TRUE == padapter->registrypriv.en_mcc) {
		PADAPTER pbuddy_adapter = padapter->pbuddy_adapter;
		struct mcc_obj_priv *pmccobjpriv = &(adapter_to_dvobj(padapter)->mcc_objpriv);

		DBG_871X("=== _enter_critical_mutex(mcc_mutex) ===\n");
		
		_enter_critical_mutex(&pmccobjpriv->mcc_mutex, NULL);
		if (rtw_hal_check_mcc_status(padapter, MCC_STATUS_NEED_MCC)){
			if (rtw_hal_check_mcc_status(padapter, MCC_STATUS_DOING_MCC)) {
				DBG_871X(FUNC_ADPT_FMT": stop mcc mode after disconnet\n", FUNC_ADPT_ARG(padapter));

				/* return _FALSE for stopping sucessfully */
				if (_FALSE == rtw_hal_set_mcc_setting(padapter,  _TRUE)) 
					//pmccobjpriv->need_mcc = _FALSE;
					rtw_hal_clear_mcc_status(padapter, MCC_STATUS_NEED_MCC);
				
				DBG_871X("mcc_status:0x%02x\n", pmccobjpriv->mcc_status);
			} else {
				/* not under do_mcc, but under need_mcc ==> sitesurvey */
				//pmccobjpriv->need_mcc = _FALSE;
				rtw_hal_clear_mcc_status(padapter, MCC_STATUS_NEED_MCC);
				DBG_871X(FUNC_ADPT_FMT": driver is not under do_mcc mode when disconnet(0x%02x)\n", 
					FUNC_ADPT_ARG(padapter), pmccobjpriv->mcc_status);
			}
			//re-downloading rsvd pages for LPS if buddy is linked
#ifdef CONFIG_LPS
			if (pbuddy_adapter->iface_type == IFACE_PORT0)
				rtw_lps_ctrl_wk_cmd(pbuddy_adapter, LPS_CTRL_CONNECT, 0);
#endif
		} else {
			DBG_871X("MCC already stops\n");
		}
		_exit_critical_mutex(&pmccobjpriv->mcc_mutex, NULL);
		DBG_871X("=== _exit_critical_mutex(mcc_mutex) ===\n");
	}
#endif /* CONFIG_MCC_MODE */
#endif /* CONFIG_DUALMAC_CONCURRENT */
...
#ifdef CONFIG_MCC_MODE
	if (_TRUE == padapter->registrypriv.en_mcc) {
		rtw_hal_set_hwreg(padapter, HW_VAR_SET_MCC_RSVD_PAGE, NULL);
	}
#endif
	...
	if (is_client_associated_to_ap(padapter))
	{
		...
		if (_TRUE == padapter->registrypriv.en_mcc) {
			if (check_fwstate(&(padapter->mlmepriv), _FW_UNDER_SURVEY) == _TRUE 
				...
				if (0)
					DBG_871X("MCC(%s): fwstate:0x%x, buddy_fwstate:0x%x\n", __func__, get_fwstate(&(padapter->mlmepriv)), 
...
#ifdef CONFIG_MCC_MODE
					&& (!rtw_hal_check_mcc_status(padapter, MCC_STATUS_NEED_MCC))  /* FW tx nulldata under MCC mode, we just check  ap is alive */
#endif /* CONFIG_MCC_MODE */
				) {
					#ifdef DBG_EXPIRATION_CHK
...
void clnt_sa_query_timer_hdl(_adapter *padapter)
{
...
void ap_sa_query_timer_hdl(struct sta_info *psta)
{
	...
	if (pmlmeext->sitesurvey_res.state == SCAN_DISABLE)
	{
		...
		if (_TRUE == padapter->registrypriv.en_mcc) {
			...
			if (rtw_hal_check_mcc_status(padapter, MCC_STATUS_DOING_MCC)) {			
				...
				DBG_871X(FUNC_ADPT_FMT": stop mcc mode under scanning!\n", FUNC_ADPT_ARG(padapter));

				/* return _FALSE for stopping MCC sucessfully */
				if(_FALSE == rtw_hal_set_mcc_setting(padapter,  _TRUE)) 
					DBG_871X("stop mcc mode success, mcc_status:0x%02x\n", pmccobjpriv->mcc_status);
				else
...
#endif /* CONFIG_MCC_MODE */
		/* issue null data if buddy is associated to the AP */
		if (is_client_associated_to_ap(padapter->pbuddy_adapter) == _TRUE) {
			...
			DBG_871X(FUNC_ADPT_FMT": adapter is scanning(buddy_adapter is linked), issue nulldata(pwrbit=1)\n", 
				FUNC_ADPT_ARG(padapter));
...
#ifdef CONFIG_MCC_MODE
			/* enable MCC and another interface is AP/GO */
			if (_TRUE == padapter->registrypriv.en_mcc ) {				
				if (rtw_hal_check_mcc_status(padapter, MCC_STATUS_NEED_MCC)) {

					u8 buddy_ch = padapter->pbuddy_adapter->mlmeextpriv.cur_channel;
					u8 buddy_bw = padapter->pbuddy_adapter->mlmeextpriv.cur_bwmode;
					u8 buddy_choffset = padapter->pbuddy_adapter->mlmeextpriv.cur_ch_offset;
					u8 status = 0;
					
					DBG_871X("ch:%d, offset:%d, bw:%d\n", pmlmeext->cur_channel, pmlmeext->cur_ch_offset, pmlmeext->cur_bwmode);
					/* switch to sta/GC channel */
					set_channel_bwmode(padapter, pmlmeext->cur_channel, pmlmeext->cur_ch_offset, pmlmeext->cur_bwmode);
					DBG_871X(FUNC_ADPT_FMT" issue Null data1\n", FUNC_ADPT_ARG(padapter));
					status = issue_nulldata(padapter, NULL, 1, 3, 50);
					DBG_871X("MCC nulldata1 status:%d\n", status);

					/* return to AP/GO channel to avoid client disconneting from AP/GO */
					set_channel_bwmode(padapter, 
						buddy_ch, buddy_choffset, buddy_bw);
				} else
...
extern u8 rtw_ap_bmc_frames_hdl(_adapter *padapter);

u8 tx_beacon_hdl(_adapter *padapter, unsigned char *pbuf)
{
	struct mlme_priv *pmlmepriv = &padapter->mlmepriv;
	
	rtw_ap_bmc_frames_hdl(padapter);
			...
			check_fwstate(pbuddy_mlmepriv, _FW_LINKED))
	{
		...
		if(join_res >= 0)
		{
			...
			if (_TRUE == padapter->registrypriv.en_mcc) {
				...
				DBG_871X(FUNC_ADPT_FMT" start MCC mode under station mode(buddy adapter is ap mode), CH=%d, offset=%d, BW=%d\n", 
						FUNC_ADPT_ARG(padapter), pmlmeext->cur_channel, pmlmeext->cur_ch_offset, pmlmeext->cur_bwmode);
				/* return _TURE for starting MCC sucessfully */
				rtw_hal_set_mcc_setting(padapter , _FALSE);

				_exit_critical_mutex(&pmccobjpriv->mcc_mutex, NULL);
			}	
			DBG_871X("MCC(%s), mcc_status=0x%02x\n", __func__, pmccobjpriv->mcc_status);
			if(!rtw_hal_check_mcc_status(padapter, MCC_STATUS_NEED_MCC))
#endif /* CONFIG_MCC_MODE */
			{
				u8 *p;
				...
				if(pbuddy_mlmeext->cur_bwmode == CHANNEL_WIDTH_40)		
				{
					...
					set_channel_bwmode(padapter, pbuddy_mlmeext->cur_channel, pbuddy_mlmeext->cur_ch_offset, 
						(pbuddy_mlmeext->cur_bwmode > pmlmeext->cur_bwmode)?pbuddy_mlmeext->cur_bwmode:pmlmeext->cur_bwmode);
	...
	{		
		...
		{	
			...
			if (_TRUE == padapter->registrypriv.en_mcc) {
				...
				DBG_871X(FUNC_ADPT_FMT" start MCC mode under station mode(buddy adapter is station/GC mode), CH=%d, offset=%d, BW=%d\n", 
							FUNC_ADPT_ARG(padapter), pmlmeext->cur_channel, pmlmeext->cur_ch_offset, pmlmeext->cur_bwmode);
...
#ifdef CONFIG_MCC_MODE
	if (_TRUE == padapter->registrypriv.en_mcc) {
		DBG_871X(FUNC_ADPT_FMT": enable MCC, don't check\n", FUNC_ADPT_ARG(padapter));
		goto exit;
	}
#endif /* CONFIG_MCC_MODE */
...
/**
 * rtw_is_one_netif_up¡G
 * Check the whether there is one net_device in up state
 *
 * Arguments:
 * @padapter: _adapter pointer.
 *
 * Return:
 * _TRUE: Least one of net_device is in up state.
 * _FALSE: All of net_devices are in down state.
 *
 * Auther: Arvin Liu
  * Date: 2015/05/29
 */
bool rtw_is_one_netif_up(_adapter *padapter)
{
	struct dvobj_priv *dvobj = adapter_to_dvobj(padapter);
