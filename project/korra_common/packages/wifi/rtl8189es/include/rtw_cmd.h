...
extern u8 rtw_set_sleep_macid_cmd(_adapter  *padapter, u32 sta_macid, u32 sleep_wakeup);
...
enum rtw_h2c_cmd
{
	...
	GEN_CMD_CODE(_set_sleep_macid), /*65*/
...
struct _cmd_callback 	rtw_cmd_callback[] = 
{
	...
	{GEN_CMD_CODE(_set_sleep_macid), NULL}, /*65*/
};
#endif
