...
#ifneq ($(CONFIG_BSP_REALTEK),)
CPPFLAGS += -DLITTLE_ENDIAN
CPPFLAGS += -I$(TOPDIR)/include -I$(TOPDIR)/include/asm/arch -I$(TOPDIR)/include/asm/arch/rbus
#endif

ifeq ($(CONFIG_QC_VERIFY),y)
CPPFLAGS += -I$(TOPDIR)/qc_verify/include
endif
