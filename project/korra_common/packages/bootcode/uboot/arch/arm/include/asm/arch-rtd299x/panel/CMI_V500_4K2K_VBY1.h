 ...
 * Display Setup
 */
#define CONFIG_DISPLAY_PORT 2			// 0: single port, 1: double port
...
#define CONFIG_DISPLAY_CLOCK_MAX 300
#else
#define CONFIG_DISPLAY_CLOCK_MAX 300
#endif
#define CONFIG_DISPLAY_CLOCK_MIN 				126
#define CONFIG_DISPLAY_REFRESH_RATE 120

#define CONFIG_DISPLAY_CLOCK_TYPICAL 297*1000000//74.5*1000000
...
#define CONFIG_DISPLAY_PORT_CONFIG2	0x89abcdef

///////////////////////////
//SR Settings
//////////////////////////
#define CONFIG_SR_MODE						0			//0:Hx2/Vx2, 1:Vx2, 2:Hx2, 3:SR_bypass
#define CONFIG_SR_PIXEL_MODE				2			//0:1 pixel, 1:2 pixel, 2:4 pixel

///////////////////////////
// SFG
///////////////////////////
#define CONFIG_SFG_SEG_NUM				4
#define CONFIG_SFG_PORT_NUM				16

#define CONFIG_PANEL_TYPE				1
...
// Panel Name
///////////////////////////
#define CONFIG_DISP_PANEL_NAME			"CMI_V500_4K2K_VBY1.h"
