 ...
 * Display Setup
 */
#define CONFIG_DISPLAY_PORT 					        1       // 0: single port, 1: double port 2:4 port
...
//////////////////////////
#define CONFIG_DISPLAY_PORT_CONFIG1	0x00010000
...
#define CONFIG_LVDS_4_PORTS_INDEX				13 // 13: RTK demo board V3	(b8028004=0x2e4(2ch)/0x4e4(4ch))

///////////////////////////
// Panel Name
///////////////////////////
#define CONFIG_DISP_PANEL_NAME			"au_t550QVF01_demo_v3.h"
