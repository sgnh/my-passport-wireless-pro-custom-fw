...
#define CONFIG_DISPLAY_CLOCK_MIN 				50
 ...
 */
#define CONFIG_DISP_HORIZONTAL_TOTAL 			2200
#define CONFIG_DISP_VERTICAL_TOTAL 			        1125 //1124
...
#define CONFIG_DISP_HSYNC_LASTLINE 				2200
...
//Off --> On Sequence
/////////////////////////////
#define	PANEL_TO_LVDS_ON_ms						100	// Delay(T1+T2): Panel Power --> LVDS Signal
...
//Backlight
////////////////////////////
#define CONFIG_BACKLIGHT_PWM_FREQ				160//240
...
#define CONFIG_3D_SG_OUTPUT_120HZ_ON				1	// 0: 3D SG output 60Hz; 1: 3D SG output 120Hz
#define CONFIG_3D_SG_24HZ_OUTPUT_FHD_ON				1	// 3D SG output FHD when input is 24Hz 0: OFF(960x1080@120Hz); 1: ON(FHD@60Hz)
#define CONFIG_SCALER_2D_3D_CVT_HWSHIFT_ON			1	// 0: Enable 2Dcvt3D function; 1: Enable 2Dcvt3D function


/////////////////////////
// LVDS 4 Port mapping table
/////////////////////////		// 4 port LVDS has 24 types mapping table
#define CONFIG_LVDS_4_PORTS_INDEX						11 // 11: for m3 skyworth_china; 2: for m3 skyworth_taiwan
...
#define CONFIG_PANEL_TYPE				2 //(2: LVDS 4k2k+2k1k (NEED define CUSTOM INDEX)
#define CONFIG_PANEL_CUSTOM_INDEX		1 // M3_CMI_55                                       // #define BACKLIGHTLEVEL_9WINDOWS 50
...
// Panel Name
///////////////////////////
#define CONFIG_DISP_PANEL_NAME			"CMI_Millet3_v500_4k2k.h"
