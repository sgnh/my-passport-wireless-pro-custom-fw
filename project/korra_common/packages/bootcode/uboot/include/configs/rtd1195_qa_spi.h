...
#define CONFIG_PMX_SPI
#define CONFIG_PMX_BOOTUP_FROM_USB
...
//#define CONFIG_NAND_ON_THE_FLY_TEST_KEY
    ...
    #define CONFIG_BOOTARGS DEFAULT_BOOTARGS_AND_BOOTCODE_VERSION(PMX_LOADER_VERSION)
	#define DEFAULT_BOOTARGS_AND_BOOTCODE_VERSION(x) \
		"console=ttyS0,115200 earlyprintk loglevel=4 root=/dev/sdd1 rootfstype=ext4 rw rootwait rootflags=commit=3600 panic=10 ubv="x""
	...
	#define CONFIG_NORMAL_FROM_USB_VMLINUX			"normal.knl"
	#define CONFIG_RESCUE_FROM_USB_VMLINUX			"rescue.knl"
	#define CONFIG_NORMAL_FROM_USB_DTB			"normal.dtb"
	#define CONFIG_RESCUE_FROM_USB_DTB			"rescue.dtb"
	#define CONFIG_RESCUE_FROM_USB_ROOTFS			"rescuefs.img"
	...
	#define CONFIG_RECOVERY_FROM_USB_VMLINUX		"boot.img"
	#define CONFIG_RECOVERY_FROM_USB_DTB			"boot.inf"
	//#define CONFIG_RECOVERY_FROM_USB_ROOTFS			"boot.disk"
	#define CONFIG_RECOVERY_FROM_USB_FW_PREFIX		"MyPassport"
    #endif /* CONFIG_BOOT_FROM_USB */

	/* GPIO */
	#define CONFIG_PMX_WD_BTM_GPIO_NUM	18
#else
