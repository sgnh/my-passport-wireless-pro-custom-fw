/*
 * Realtek 1195 common configuration settings
 *
 * Won't include this file.
 * Just type "make <board_name>_config" and will be included in source tree.
 */

#ifndef __CONFIG_RTK_RTD1195_COMMON_H
#define __CONFIG_RTK_RTD1195_COMMON_H

#define CONFIG_BOOTCODE2
...
#define CONFIG_SPI_NORMAL_DTS          0x003F0000
#define CONFIG_SPI_NORMAL_DTS_SIZE     0x10000
#define CONFIG_SPI_NORMAL_KERNEL       0x00100000
#define CONFIG_SPI_NORMAL_KERNEL_SIZE  0x280000
#define CONFIG_SPI_RESCUE_DTS          0x007F0000
#define CONFIG_SPI_RESCUE_DTS_SIZE     0x10000
#define CONFIG_SPI_RESCUE_KERNEL       0x00500000
#define CONFIG_SPI_RESCUE_KERNEL_SIZE  0x2F0000
#define CONFIG_SPI_BLUECORE_AUDIO      0x00400000
#define CONFIG_SPI_BLUECORE_AUDIO_SIZE 0x100000
...
#define CONFIG_INSTALL_GPIO_NUM    		4
...
#endif /* __CONFIG_RTK_RTD1195_COMMON_H */
