...
/* common/emmc.c */
int rtk_eMMC_write( unsigned int address, unsigned int data_size, unsigned int * buffer);
int rtk_eMMC_read( unsigned int address, unsigned int data_size, unsigned int * buffer);
#endif
