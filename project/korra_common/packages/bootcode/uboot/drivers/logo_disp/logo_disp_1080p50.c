 ...
 *
 *  This file implements logo display function in 1080p50 mode
 *
 ************************************************************************/
 ...
 ************************************************************************/
static void LOGO_DISP_1080p50(t_extern_param *logo, int bond_opt);

#if defined(CONFIG_SYS_LOGO_DISP_1080P50)

void  LOGO_DISP_setup(t_extern_param *logo_param_ptr)
{
	int bonding = 0;
//	bonding = (*(volatile unsigned int *)ISO_CHIP_INFO1) & M_BONDING;
	printf("1080p 50Hz logo\n");
	LOGO_DISP_1080p50(logo_param_ptr, bonding);
}
