...
DECLARE_GLOBAL_DATA_PTR;
	...
	!defined(CONFIG_ENV_IS_IN_FACTORY)	&& \
	!defined(CONFIG_ENV_IS_NOWHERE)
# error Define one of CONFIG_ENV_IS_IN_{EEPROM|FLASH|DATAFLASH|ONENAND|\
SPI_FLASH|NVRAM|MMC|FAT|REMOTE|FACTORY} or CONFIG_ENV_IS_NOWHERE
#endif
...
#if 0 //defined(CONFIG_CMD_EDITENV) // the same as "env edit"
U_BOOT_CMD_COMPLETE(
